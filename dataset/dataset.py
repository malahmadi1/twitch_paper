...
class Twitchdataset(Dataset):
    ...
    def __init__(
        self,
        root='data/chats_data_sampled_combined.xlsx - Combined_round_2k.csv',
        tokenizer = None,
        chunk_len = 10,
        overlap_len = 5,
    ):
    ...
    def process_data(self, root):
        ...
        # Drop everything except the following, convert everything to string and drop None value
    ...
    def long_terms_tokenizer(self, data_tokenize, targets):
        ...
        # Creating batching for long comment
